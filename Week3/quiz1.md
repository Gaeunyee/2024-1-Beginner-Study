...
- 답: 1: 브랜치의 커밋이 그대로 main에 병합

2: 브랜치의 커밋들을 하나의 커밋으로 합쳐서 병합

3: 브랜치의 커밋들을 main의 새로운 커밋으로 변경함
...
- 답: 가장 최근에 develop 브랜치에서 docs: readme 추가를 커밋했다. id: a1s2d3f
...
- 답: revert, reset은 커밋을 지워버리기 때문에 다른 팀원들과 기록이 꼬일 수 있다...
